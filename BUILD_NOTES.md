...
| `src/convex/simulator.ts` | §7.6 what-if projection + Apply. Contains **zero** copies of scoring/allocation/trust math — it calls the exported functions from `allocation.ts` (§7.6.1). |
